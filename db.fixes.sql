...
--- revoking access
REVOKE ALL ON DATABASE lost_found_sys FROM PUBLIC;  --- revoke access & grants to database from public
...
-- GRANT SELECT ON ..., ... TO center_admin;
-- GRANT INSERT ON ..., ... TO center_admin;
-- GRANT DELETE ON ..., ... TO center_admin;
-- GRANT UPDATE ON ..., ... TO center_admin;
-- GRANT TRUNCATE ON ..., ... TO center_admin;
